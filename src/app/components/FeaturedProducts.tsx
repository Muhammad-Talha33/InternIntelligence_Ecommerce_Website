...
import { fetchFeaturedProducts } from "../../sanity/fetchProducts";
    ...
    <motion.section className="py-16" initial={{ opacity: 0, y: -100 }} 
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-12">
          <Link
            href="/products"
            className="inline-block py-3 px-8 border border-gray-300 text-gray-800 font-medium rounded-md hover:bg-gray-50 transition-colors"
          >
            View All Products
          </Link>
        </div>
